...
MAIN_ATTRIBUTES = [
    ...
    , 'waistsize', 'lubricant_dry', 'lubricant_packaging', 'lubricant_type', 'lubrication_cleans', 'lubrication_preserves', 'die_calibre', 'die_family', 'die_function', 'die_qty', 'calibre_suitable', 'die_application', 'bushing_material', 'bushing_size', 'crimp_die_adjust', 'crimp_die_type', 'die_2_material', 'die_price_cat', 'expand_die_type', 'screw_thread', 'seat_die_adjust', 'seat_die_type', 'size_die_2_expander', 'size_die_2_type', 'size_die_expander', 'size_die-type'
]
...
with open('catalog_product_20171013_export.csv', 'rt', encoding='UTF-8') as f, open('catalog_product_20171013_export_for_upload.csv', 'w') as n:
